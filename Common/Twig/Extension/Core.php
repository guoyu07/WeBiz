...
class Twig_Extension_Core extends Twig_Extension
{
    ...
    public function getFilters()
    {
        $filters = array(
            ...
            new Twig_SimpleFilter('nl2br', 'nl2br', array('pre_escape' => 'Views', 'is_safe' => array('Views'))),
 ...
 * @return string
 */
function twig_escape_filter(Twig_Environment $env, $string, $strategy = 'Views', $charset = null, $autoescape = false)
{
    ...
    if (!is_string($string)) {
        ...
        } elseif (in_array($strategy, array('Views', 'js', 'css', 'html_attr', 'url'))) {
            return $string;
        }
    }
    ...
    switch ($strategy) {
        ...
        default:
            ...
            $validStrategies = implode(', ', array_merge(array('Views', 'js', 'url', 'css', 'html_attr'), array_keys($escapers)));
